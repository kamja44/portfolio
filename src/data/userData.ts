...
export const aboutContent = {
  paragraphs: [
    ...
    "프론트엔드 기술을 넘어 AI 통합에도 관심이 많습니다. OpenAI CLIP 모델 기반 이미지 검색, Face-API.js 얼굴 인식, OpenAI GPT API를 활용한 레시피 생성 등 AI를 프론트엔드에 통합한 경험이 있습니다. 최신 프론트엔드 기술(React 19, Next.js 16, Tailwind CSS v4)을 적극적으로 도입하며, 프론트엔드와 AI의 경계를 넘나드는 개발자로 성장하고 있습니다.",
  ],
};
